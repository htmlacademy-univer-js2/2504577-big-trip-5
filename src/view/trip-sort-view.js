...
function createSortTemplate() {
  return (`<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            ${TYPES_SORT.map((sort) => (["event", "offers"].includes(sort) ? createSortItemTemplate(sort, false, true) : sort === "day" ?
            createSortItemTemplate(sort, true) : createSortItemTemplate(sort))).join("")}
          </form>`);
}
